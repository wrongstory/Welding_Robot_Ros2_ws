...
public:
   ...
   * @param node
   */
  LoopDetector(rclcpp::Node::SharedPtr node) : node_(node) {
    ...
    // Use get_parameter since fitness_score_thresh may already be declared by information_matrix_calculator
